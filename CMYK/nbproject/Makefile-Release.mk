...
${OBJECTDIR}/BogoRobot.o: BogoRobot.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BogoRobot.o BogoRobot.cpp
...
${OBJECTDIR}/Pojemnik.o: Pojemnik.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Pojemnik.o Pojemnik.cpp

${OBJECTDIR}/RekurencyjnyRobot.o: RekurencyjnyRobot.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/RekurencyjnyRobot.o RekurencyjnyRobot.cpp
...
${OBJECTDIR}/WybierajacyRobot.o: WybierajacyRobot.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/WybierajacyRobot.o WybierajacyRobot.cpp
